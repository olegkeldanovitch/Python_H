...
result_division = int(result_division)
result_int = round(result_division)
#  28. Вывести result_int в консоль.
print('result_int =', result_int, type(result_division))
...
print('===================')
print('Реализация через арифметические действия с присваиванием')
